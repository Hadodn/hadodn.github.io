...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Releases.data';
    var REMOTE_PACKAGE_BASE = 'Releases.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 26893913;
      var PACKAGE_UUID = '69c35771-bffb-48d3-9041-fb362dd2b806';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 23551810, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(23551810, 23551831, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(23551831, 25369595, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(25369595, 26866287, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(26866287, 26893913, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Releases.data');

    };
    Module['addRunDependency']('datafile_Releases.data');
